// Type definitions for midi 2.0 from @types/midi, modified because they were actually wrong (invalid import of EventEmitter, see below)
declare module 'midi' {
  ...
  // import * as EventEmitter from 'events'; // invalid original import from @types/midi
  import { EventEmitter } from 'events'; // my fix
